...
const LandingDomesticStockInsightSection = ({
  section,
  ...
  return (
    <Wrapper>
      ...
      {/* {appliedSlotLabel?.description ? (
        <SectionMeta>{appliedSlotLabel.description}</SectionMeta>
      ) : null} */}
...
export default LandingDomesticStockInsightSection;
...
const StockCard = ({
  ...
  //   ? "종목 코멘트"
  //   : rawCommentTitle || "종목 코멘트";
  const commentTitle = "종목 코멘트";
...
const StockCTAGroup = styled.div`
  display: flex;
  gap: 8px;
  flex-wrap: wrap;
  margin: 8px 0 16px;
...
const CTAHelperText = styled.small`
  flex-basis: 100%;
  font-size: 12px;
  color: #6b7280;
`;

...
const BASE_LABELS: Record<BriefingSlot, SlotLabel> = {
  ...
  slot2: { phase: "slot2", title: "오전 1차 브리핑", description: "11:00 장 중 핵심 업데이트" },
  slot3: { phase: "slot3", title: "오후 2차 브리핑", description: "14:30 점심 이후 점검" },
  slot4: { phase: "slot4", title: "장 마감 직전 브리핑", description: "17:00 마감 직전 체크" },
  slot5: { phase: "slot5", title: "저녁 리뷰 브리핑", description: "21:00 저녁 재랭킹" },
...
const OVERSEAS_LABELS: Record<BriefingSlot, SlotLabel> = {
  ...
  slot2: { phase: "slot2", title: "미국장 오전 리마인드", description: "11:00 간밤 후속 업데이트" },
  slot3: { phase: "slot3", title: "오늘 밤 미국장 프리뷰 1차", description: "14:30 오늘 밤 주목 포인트" },
  slot4: { phase: "slot4", title: "오늘 밤 미국장 프리뷰 2차", description: "17:00 마감 전 리마인드" },
  slot5: { phase: "slot5", title: "미국 프리마켓 체크", description: "21:00 프리마켓 동향" },
...
const CRYPTO_LABELS: Record<BriefingSlot, SlotLabel> = {
  ...
  slot2: { phase: "slot2", title: "오전 코인 브리핑", description: "11:00 오전 급등락 체크" },
  slot3: { phase: "slot3", title: "점심·오후 브리핑", description: "14:30 점심 이후 반응" },
  slot4: { phase: "slot4", title: "퇴근 직전 브리핑", description: "17:00 오후 변동성 요약" },
  slot5: { phase: "slot5", title: "심야 브리핑", description: "21:00 밤 시간대 미국장 반응" },
